 ...
 */
public class ThreatLevels extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        tableCreator.appendTableHeader(context, mainLayout, LegendHeadings.THREAT_LEVEL,
        ...
        radioThreatLevel.setChecked(true);
    ...
    public static ThreatLevels newInstance(ScanResults scanResults) {
        ThreatLevels fragment = new ThreatLevels();
