    ...
    public void onViewCreated(View view, Bundle savedInstancesState) {
        ...
        for (String host : availabilityImpactScore.keySet()) {
            ...
            table.prepareTableRow(new TableRow(new TableRowData(host, Gravity.CENTER,this),
                    new TableRowData(String.valueOf(availabilityScoreCount.getHighCount()), Gravity.CENTER, this),
                    new TableRowData(String.valueOf(availabilityScoreCount.getLowCount()), Gravity.CENTER, this),
                    new TableRowData(String.valueOf(availabilityScoreCount.getTotal()), Gravity.CENTER, this)));
        }
